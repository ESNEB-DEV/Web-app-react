...
function PopularMenu() {
    return (
        <div className=" flex flex-col md:flex-row justify-center py-16 bg-[url('src/assets/img/popular-bg.png')] bg-auto md:bg-cover md:bg-no-repeat bg-center bg-top">
            <div>
                <div className='w-full flex justify-center flex-col items-center'>
                    <h1 className='text-5xl font-extrabold font-sans '>POPULAR MENU</h1>
                    <p className='text-gray-600 mt-4 text-md text-center font-sans px-5 md:w-[50rem] lg:w-[50rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, laborum? Nulla laboriosam cupiditate temporibus autem!</p>
                </div>
                <div className="flex flex-col md:flex-row pt-4 py-10">
                    ...
                    <div className="w-full md:w-1/3 p-4 px-8">
                        <img src='src/assets/img/package-3.png' alt="Package 3" className='mx-auto'></img>
