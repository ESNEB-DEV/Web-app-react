        ...
        <div className=" flex flex-col md:flex-row justify-center py-16 bg-[url('src/assets/img/stats-bg.png')] bg-no-repeat bg-cover bg-center bg-top">
            <div>
                <div className='w-full flex justify-center flex-col items-center'>
                    ...
                    <p className='text-gray-600 mt-4 text-md text-center font-sans  px-5 md:w-[50rem] lg:w-[50rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima aut reiciendis iusto similique, dolores veritatis. Exercitationem nesciunt saepe repellat officia veniam</p>
                </div>
                <div className="flex flex-col md:flex-row pt-5 gap-10 px-10">
                    <div className="flex-1 w-full md:w-1/3 p-5 border-4 h-60 border-black flex justify-center items-center flex-col">
